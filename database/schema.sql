...
CREATE TABLE IF NOT EXISTS comments(id INTEGER PRIMARY KEY, username TEXT, ref_comment_id INTEGER, review_id INTEGER, body TEXT, date TEXT, FOREIGN KEY (ref_comment_id) REFERENCES comments (id), FOREIGN KEY (review_id) REFERENCES reviews (id));
